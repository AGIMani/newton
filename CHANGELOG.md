...
- Train the Nero + L10 Diffusion Policy only from successful, deduplicated clips, use raw-episode-grouped train/validation splits, and bound per-worker H.264 decoder resources; use `dataset_split.json` to reproduce or audit a run.
